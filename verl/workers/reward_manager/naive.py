...
class NaiveRewardManager:
    ...
    def __call__(self, data: DataProto, return_dict=False):
        ...
        other_tensor = torch.zeros_like(data.batch["responses"], dtype=torch.float32)
        ...
        for i in range(len(data)):
            ...
            acc_tensor[i, valid_response_length - 1] += acc_score
            format_tensor[i, valid_response_length - 1] += format_score
            other_tensor[i, valid_response_length - 1] += other_score
        ...
        if return_dict:
            ...
            return reward_tensor,acc_tensor, format_tensor, other_tensor
